...
export const t = {
    ko: {
        ...
        proj_done: '완성',
        proj_pending: '시작전', proj_in_progress: '진행중', proj_done: '완성',
        proj_progress_label: '진행률',
        proj_public: '공개', proj_private: '비공개',
        // 파트
        part_new: '파트 추가',
        part_empty: '등록된 파트가 없습니다.',
        ...
        part_status_pending: '시작전', part_status_in_progress: '진행중', part_status_done: '완료',
    ...
    en: {
        ...
        proj_empty: 'No ongoing projects. Tap + to create one.',
        ...
        proj_edit: 'Edit',
        proj_pending: 'Pending', proj_in_progress: 'In Progress', proj_done: 'Done',
        proj_progress_label: 'Progress',
        proj_public: 'Public', proj_private: 'Private',
        // Parts
        part_new: 'Add Part',
        part_empty: 'No parts added yet.',
        ...
        part_status_pending: 'Pending', part_status_in_progress: 'Active', part_status_done: 'Done',
        part_mark_done: 'Mark as Done',
        part_mark_in_progress: 'Set In Progress',
        part_open_counter: 'Open Counter',
    ...
    ja: {
        ...
        proj_new: '新しいプロジェクト',
        proj_empty: '進行中のプロジェクトがありません。＋ボタンで追加できます。',
        ...
        proj_edit: '編集',
        proj_pending: '準備中', proj_in_progress: '進行中', proj_done: '完成',
        proj_progress_label: '進捗',
        proj_public: '公開', proj_private: '非公開',
        // パーツ
        part_new: 'パートを追加',
        part_empty: '登録されたパーツがありません。',
        ...
        part_status_pending: '準備中', part_status_in_progress: '進行中', part_status_done: '完了',
        part_mark_done: '完了としてマーク',
        part_mark_in_progress: '進行中に変更',
        part_open_counter: 'カウンターを開く',
