...
const translations = {
    ko: {
        ...
        footer_generate: "도안 만들기",
        footer_mypage: "내 도안",
        footer_about: "소개",
        footer_privacy: "개인정보처리방침",
        copyright_notice: "⚠️ 타인의 사진·캐릭터·예술 작품으로 생성한 도안을 상업적으로 이용할 경우 저작권법 위반의 책임은 전적으로 이용자 본인에게 있습니다. <a href='/privacy.html#disclaimer'>자세히 보기</a>",
    ...
    en: {
        ...
        footer_generate: "Create Pattern",
        footer_mypage: "My Patterns",
        footer_about: "About",
        footer_privacy: "Privacy Policy",
        copyright_notice: "⚠️ You are solely responsible for any copyright infringement if you use patterns generated from others' photos, characters, or artwork for commercial purposes. <a href='/privacy.html#disclaimer'>Learn more</a>",
    ...
    ja: {
        ...
        copyright_notice: "⚠️ 他者の写真・キャラクター・芸術作品から生成した編み図を商業目的で利用する場合、著作権法違反の責任はすべて利用者本人にあります。<a href='/privacy.html#disclaimer'>詳細を見る</a>",
